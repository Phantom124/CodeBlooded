...
StaffInterface::StaffInterface(ProxyGreenHouseInventory *inventory, StaffSystem *staffSystem) {
    this->GreenHouse = inventory;
    ...
    this->roseFactory = new RoseFactory(waterMonitor, fertilizerMonitor, deadMonitor, insertQueryBuilder, inventory);
    this->sunflowerFactory = new SunflowerFactory(waterMonitor, fertilizerMonitor, deadMonitor, insertQueryBuilder, inventory);
    this->cactusFactory = new CactusFactory(waterMonitor, fertilizerMonitor, deadMonitor, insertQueryBuilder, inventory);
}
...
void StaffInterface::addPlant(){
    ...
    if(newPlant != nullptr){
        this->GreenHouse->insertPlant(newPlant);
        std::cout << "Plant added to inventory.\n";
    } else {
        std::cout << "Failed to create plant.\n";
    }
